-- Legg til 'no_response' i status-sjekken for outreach_targets.
...
ALTER TABLE public.outreach_targets ADD CONSTRAINT outreach_targets_status_check
  CHECK (status IN ('not_contacted','queued','contacted','no_response','follow_up','responded','declined','onboarded'));
