...
export default function Navbar({
  ...
  return (
    <header className={`sticky top-0 z-50 border-b border-neutral-200/60 transition-all duration-300 ${isHome ? "glass-navbar" : "bg-white"}`} style={{ paddingTop: "env(safe-area-inset-top)" }}>
